package aerys.minko.scene.graph.mesh.modifier
{
	...
	public class NormalMesh extends AbstractMeshModifier
	{
		...
		public static const VERTEX_FORMAT	: PackedVertexFormat	= new PackedVertexFormat(new VertexComponent(["nx", "ny", "nz"],
		...
		{
			var normalsFormat	: PackedVertexFormat	= VERTEX_FORMAT;
