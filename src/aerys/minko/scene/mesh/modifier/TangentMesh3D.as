package aerys.minko.scene.mesh.modifier
{
	...
	public class TangentMesh3D extends AbstractMeshModifier3D
	{
		public static const VERTEX_FORMAT	: PackedVertex3DFormat	=
			new PackedVertex3DFormat([
				new Vertex3DComponent(["tx", "ty", "tz"], NativeFormat.FLOAT_3),
				new Vertex3DComponent(["nx", "ny", "nz"], NativeFormat.FLOAT_3),
				new Vertex3DComponent(["bx", "by", "bz"], NativeFormat.FLOAT_3)
			]);
