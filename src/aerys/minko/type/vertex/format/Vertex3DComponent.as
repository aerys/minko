package aerys.minko.type.vertex.format
{
	public class Vertex3DComponent
	{
		...
		public static const ST		: Vertex3DComponent = new Vertex3DComponent(["s", "t"], NativeFormat.FLOAT_2);
		public static const BONE	: Vertex3DComponent	= new Vertex3DComponent(["id", "weight"], NativeFormat.FLOAT_2);
