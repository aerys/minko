package aerys.minko.type.data
{
	...
	public final class DataBindingsOld
	{
...
//		{
//			if (_values[propertyName] !== undefined)
//				throw new Error('"' + propertyName + '" is already bound by another DataProvider.');
//			
...
//			
//			if (Signal(_propertyChanged[propertyName]).numCallbacks == 0)
