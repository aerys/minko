 ...
 */
public class AndroidHeadTracker
{
	...
	// Native functions
	public native void minkoNativeOnHeadTrackerEvent(String message);

	public AndroidHeadTracker(Activity sdlActivity)
	{
	...
	{
		Log.i("minko-java", "[AndroidHeadTracker] Start tracking");
		...
		mSensorEventListener = new SensorEventListener()
		{
			public void onSensorChanged(SensorEvent event) {
				AndroidHeadTracker.this.processSensorEvent(event);
			}
		...
		Thread sensorThread = new Thread(new Runnable()
		{
			public void run() {
				...
				for (int sensorType : AndroidHeadTracker.INPUT_SENSORS) {
	...
	{
		Log.i("minko-java", "[AndroidHeadTracker] Stop tracking");
	...
	{
		Log.i("minko-java", "[AndroidHeadTracker] Process sensor event");
		...
		minkoNativeOnHeadTrackerEvent(eventData);
	}
}