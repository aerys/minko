window.Minko = 'Minko' in window && !!window.Minko ? window.Minko : (function () {
    return {
        ...
        loadedHandler: function (event) {
            if (Minko.loaded == -1 || Minko.loaded === 1)
                return;
        ...
        */
        ...
        createIframe: function () //EMSCRIPTEN
        {
            Minko.loaded = -1;
        ...
        loadUrlEmscripten: function (url) //EMSCRIPTEN
        {
         ...
         */
        setOverlayAllowedOrigins: function (allowedOrigins) {
         ...
         */
        setWindowPostMessageListener: function () {
        ...
        ** iOS/OSX
        */
        connectWebViewJavascriptBridge: function (callback) // iOS / OSX
        {
